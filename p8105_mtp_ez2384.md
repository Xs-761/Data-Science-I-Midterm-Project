...
```
    ...
    ## Warning: Failed to fit group 50.
    ...
    ## Warning: Failed to fit group 52.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 61.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 62.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 76.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 80.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 99.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 101.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 45.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
    ...
    ## Warning: Failed to fit group 48.
    ## Caused by error in `predLoess()`:
    ## ! 外接函数调用时不能有NA/NaN/Inf(arg5)
