...
###### Problem1 Discussion   
  - When merging datasets, warning message appears: Detected an unexpected many-to-many relationship between x and y variables, implying "zipcode" is not unique in `NYC_Zipcode` dataset.   
